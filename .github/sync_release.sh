...
UPSTREAM_REPO="https://github.com/MiSTer-devel/BBCMicro_MiSTer.git"
CORE_NAME=(BBCMicro)
...
UPSTREAM_CORE_NAME=(BBCMicro)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(BBCMicro.qpf)
COMPILATION_OUTPUT=(output_files/BBCMicro.rbf)
